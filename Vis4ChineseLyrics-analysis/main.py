...
# 输入和输出文件路径
input_paths = ['ChineseLyrics-master/lyrics1.json', 
...
def process_songs(input_paths):
    ...
    for input_path in input_paths:
        ...
        with open(input_path, 'r', encoding='utf-8') as infile:
            ...
            for song in tqdm(songs, desc='Processing songs',total=total_songs,mininterval=1.0):
                try:
                    cleaned_lyric = lyricCleaner.clean_lyrics(song.get('lyric', ''))  # 使用 .get 避免 KeyError
